...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("MasterTrader-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("MasterTrader-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MasterTrader " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("MasterTrader-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("MasterTrader-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("MasterTrader-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("MasterTrader-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MasterTrader is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("MasterTrader-start");

...
{
    resize(850, 550);
    setWindowTitle(tr("MasterTrader") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a MasterTrader address"));
	...
	statisticsAction->setProperty("objectName","statisticsAction");
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About MasterTrader"), this);
    aboutAction->setToolTip(tr("Show information about MasterTrader"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for MasterTrader"));
...
void BitcoinGUI::createToolBars()
{
	...
	_addButtonInToolbar(statisticsAction,toolbar);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("MasterTrader client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("MasterTrader client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MasterTrader network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid MasterTrader address or malformed URI parameters."));
    }

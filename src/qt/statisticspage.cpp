...
void StatisticsPage::updateStatistics()
{
    ...
    else if (pindexBest->nHeight+1 >= 3000 && pindexBest->nHeight+1 <= 10100)
    {
        phase = "POW/POS";
    }
	else if (pindexBest->nHeight+1 > 10100)
    {
        phase = "POS";
    }
    QString subsidy = "";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " MTR" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " MTR" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " MTR");
    }
